...
2. **Spawn initial research tasks to gather context**:
   ...
   - Use the **codebase-pattern-finder** agent to find similar patterns we can model after
...
3. **Spawn parallel sub-tasks for comprehensive research**:
   ...
   **For external information:**
   - **web-search-researcher** - To find current documentation on libraries/frameworks
...
1. **Write the plan** to `docs/plans/YYYY-MM-DD-description.md`
   ...
   - Examples:
     - `2025-11-12-add-memory-agent.md`
     - `2025-11-12-improve-error-handling.md`
...
1. **Automated Verification** (can be run by execution agents):
   - Commands that can be run: `pytest`, `mypy`, `ruff`, etc.
...
#### Manual Verification:
- [ ] New feature works correctly in main.py
- [ ] Performance is acceptable with large inputs
- [ ] Error messages are clear and helpful
- [ ] Feature integrates well with existing agents
```
...
User: We need to add a memory/context agent that can store and retrieve conversation history