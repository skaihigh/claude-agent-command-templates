---
description: Document codebase as-is for comprehensive understanding
model: opus
---
...
5. **Gather metadata for the research document:**
   ...
   - Filename: `docs/research/YYYY-MM-DD-description.md`
     ...
     - Examples:
       - `2025-11-12-supervisor-routing-logic.md`
       - `2025-11-12-agent-initialization.md`
...
6. **Generate research document:**
   ...
   - Structure the document with YAML frontmatter followed by content:
     ...
     **Repository**: langChain_and_subAgents
     ...
     ### [Component/Area 1]
     - Description of what exists ([file.ext:line](path/to/file.ext#Lline))
     ...
     - [another/file.py:45-67](another/file.py#L45-L67) - Description of the code block

     ## Architecture Documentation
     [Current patterns, conventions, and design implementations found in the codebase]

     ## Related Diagrams
     [Links to relevant Mermaid diagrams in diagrams/]
...
7. **Add GitHub permalinks (if applicable):**
   - Check if on main branch or if commit is pushed:
     ...
     ```
   - If GitHub repo exists and commit is pushed:
     - Create permalinks: `https://github.com/{owner}/{repo}/blob/{commit}/{file}#L{line}`
     - Replace local file references with permalinks in the document

8. **Present findings:**
   - Write the research document to `docs/research/`
